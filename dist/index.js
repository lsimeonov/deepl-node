...
const axiosHttpClient_1 = __importDefault(require("./clients/axiosHttpClient"));
const fetchHttpClient_1 = __importDefault(require("./clients/fetchHttpClient"));
...
class Translator {
    ...
    constructor(authKey, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.httpClient) {
            if (typeof options.httpClient === 'string') {
                // String cases
                this.httpClient =
                    options.httpClient === 'fetch'
                        ? new fetchHttpClient_1.default(httpClientParams)
                        : new axiosHttpClient_1.default(httpClientParams);
            }
            else {
                // Function case
            ...
            // Default instance
            const httpClientInstance = new axiosHttpClient_1.default(httpClientParams);
